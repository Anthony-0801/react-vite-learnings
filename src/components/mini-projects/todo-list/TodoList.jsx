        ...
        <div className='bg-white flex w-full lg:flex-row h-[90%] lg:flex-wrap lg:justify-center gap-4 flex-col'>
          {
            todo.map(item => 
              ...
              >
                ...
                <p 
                  className={item.completed ? "line-through w-full h-full font-mono font-semibold items-center flex justify-center place-self-center" : "w-full h-full hover:cursor-pointer font-mono font-semibold items-center flex justify-center place-self-center"}
