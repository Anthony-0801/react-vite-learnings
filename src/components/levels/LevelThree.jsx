...
export default function LevelThree() {
  ...
  return (
    <div>
        <h1 className='font-bold font-sans mb-2 border-b-2'>Level 3: In this level, we'll map an array list of times of day but we'll pass some props in the LevelThreePassComponent component's props and display it here at this section.</h1>
